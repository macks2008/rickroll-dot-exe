...
void rickrollTheConsole(){
	vector<string> lyrics = {"We're no strangers to loooove...", "You know the rules, and so do Iiiiii...", 
	...
	cout << "Thanks for putting up with the whole thing. You must be a true memer ;-)" << endl;
